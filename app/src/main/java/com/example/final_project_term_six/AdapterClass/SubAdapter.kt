...
import com.example.final_project_term_six.RiddleFragment
import com.example.final_project_term_six.SubFragment
import com.example.final_project_term_six.modelClass.HomeModel

class SubAdapter(private val context: Context, private val list: ArrayList<HomeModel>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { v ->
            ...
            activity.supportFragmentManager.beginTransaction()
                .replace(R.id.wrapper, RiddleFragment(model.title))
                .addToBackStack(null)
                .commit()
        }
    }
